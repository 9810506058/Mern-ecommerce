...
const UpdateProduct = () => {
  ...
  // Fetch the single product data based on the slug
  ...
  }, [slug]);  // Dependency array includes slug to refetch data if the slug changes
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      if (photo) productData.append("photo", photo);  // Only append photo if it exists
